(function (MW) {
  ...
  const Actions = Object.freeze({
    ...
    GET_REGISTRATION_OPTIONS:'get_registration_options', GET_ENTITIES:'get_entities', GET_RECONCILIATION:'get_reconciliation', AUTHORIZE_CLAIM:'authorize_claim', HEALTH:'health'
  });
  ...
  const ActionRoles = Object.freeze({
    ...
    get_records:AuthenticatedRoles, get_reconciliation:[Roles.SUPERVISOR,Roles.ADMIN], authorize_claim:[Roles.SUPERVISOR,Roles.ADMIN],
  ...
  MW.Contracts=Object.freeze({version:'1.5',Actions,Roles,RoleList,AuthenticatedRoles,EntrySources,EntityTypes,ReconciliationStatus,ActionRoles,ErrorCodes,Limits,rolesFor,isPublic,canRole});
})(window.MedWaste);
