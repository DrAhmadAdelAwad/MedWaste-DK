(function (MW) {
  ...
  MW.Contracts=Object.freeze({version:'1.13',Actions,Roles,RoleList,AuthenticatedRoles,EntrySources,EntityTypes,ReconciliationStatus,ActionRoles,ErrorCodes,Limits,rolesFor,isPublic,canRole});
})(window.MedWaste);
